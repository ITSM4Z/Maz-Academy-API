package com.maz.academy.main;

import com.maz.academy.model.*;
import com.maz.academy.service.*;
     ...
     */
     static void main() {
        ...
        if(platform.getUsers().isEmpty()){
            platform.initializeDefaultAdmin();
            System.out.println("There is no admin in the system. default admin with the name Admin has been created.");
        }
        else{
            for(User u : platform.getUsers()){
                System.out.println("Started going through user list...");
                if(u instanceof Admin){
                    System.out.println("An admin was found!");
                    break;
                }
                else{
                    platform.initializeDefaultAdmin();
