...
import com.maz.academy.enums.CourseLevel;
...
public class Instructor extends User implements Cloneable {
    ...
    private void createCourse(Platform platform){
        ...
        Course createdCourse = new Course(generator.generateID(7, false, platform), courseCapacity, courseTitle, coursePrice, courseLevel);
